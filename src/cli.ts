...
IMPORT/EXPORT
  ...
  import <dir> --database-only      Managed brains: store pages without writing
                                     them into the canonical source root
  ...
  export [--dir ./out/] [--prune]    Export to markdown (--prune removes files
                                     of pages the brain no longer has)
